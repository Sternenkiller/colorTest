$(document).ready(function () {
    ...
    $('img#glider').each(function () {
        ...
        jQuery.get(imgURL, function (data) {
            ...
            svg = svg.setattribute('height', 1000);
            svg = svg.setattribute('width', 1000);
    ...
    $(".box").on("mouseover", function () {
        ...
        $('[id^=color' + classList[0] + ']').css('fill', 'rgb(255, 255, 255)');
...
function SVGPNG(cb) {
    ...
    temp.onload = function onload() {
        ...
        ctx.fillText("Uniquecode: " + getRndInteger(11111, 99999), 10, 80);
...
function onPNG() {
    SVGPNG((src) => {
        ...
        a.href = src;
        a.download = "Swing-Color-Tool.png" //File name Here
